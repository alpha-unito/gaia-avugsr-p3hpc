...
export PATH=${COMP_PATH}/rocm/hip/bin:$PATH
export LD_LIBRARY_PATH=${COMP_PATH}/rocm/hip/lib:$LD_LIBRARY_PATH
export CPATH=${COMP_PATH}/rocm/hip/include:$CPATH
...
mkdir -p logs_test
mpirun -np 1 --mca pml ucx --mca btl_tcp_if_include mlx5_1 ../bin/GaiaGsrParSimHip.x -memGlobal $1 -IDtest 0 -itnlimit $2 > logs_test/log.1GPU_$1_$2itn_hip_$3
