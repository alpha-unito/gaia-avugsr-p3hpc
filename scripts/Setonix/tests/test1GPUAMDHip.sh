...
export OMP_NUM_THREADS=1
srun -N 1 -n 1 -c 8 --gres=gpu:1 --gpus-per-task=1 --gpu-bind=closest rocprof --stats --hsa-trace --hip-trace ../bin/GaiaGsrParSimHip.x -memGlobal $1 -IDtest 0 -itnlimit $2 > logs_test/log.1GPU_$1_hip


# module load omniperf/1.0.10

# srun -N 1 -n 1 -c 8 --gres=gpu:1 --gpus-per-task=1 --gpu-bind=closest omniperf profile -n gaia_hip -- ../bin/GaiaGsrParSimHip.x -memGlobal $1 -IDtest 0 -itnlimit $2 > logs_test/log.1GPU_$1_hip
