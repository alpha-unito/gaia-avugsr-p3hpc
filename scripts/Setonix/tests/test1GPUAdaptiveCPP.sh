...
srun -N 1 -n 1 -c 8 --gres=gpu:1 --gpus-per-task=1 --gpu-bind=closest  ../bin/GaiaGsrParSimStdparGPU_ACPP.x -memGlobal $1 -IDtest 0 -itnlimit $2 > logs_test/log.1GPU_$1_acpp
